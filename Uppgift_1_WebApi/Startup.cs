...
namespace Uppgift_1_WebApi
{
    public class Startup
    {
        ...
        public string JtwBearerDefaults { get; private set; }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            }).AddJwtBearer(j =>
            {
                j.Events = new JwtBearerEvents
                {
                    ...
                    {
                        var serviceWorkerId = int.Parse(context.Principal.Identity.Name);
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Uppgift_1_WebApi", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Uppgift_1_WebApi v1"));
            }
